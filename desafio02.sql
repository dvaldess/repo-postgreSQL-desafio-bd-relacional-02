...
-- Acceder a la base de datos recien creada
...
-- Copiar datos desde CSV a las respectivas tablas creadas anteriormente
...
-- acer una consulta SQL que muestre los títulos con su longitud, la longitud debe ser nombrado para la consulta como “longitud_titulo”.

SELECT LENGTH (pelicula) AS longitud_titulo, pelicula FROM peliculas;
